...
public class BaseSkill : MonoBehaviour
{
	...
	// If the coolDown is 'cooling down' this will be true
	// and locks the button from being pressed again.
	...
	private void Awake()
	{
		// In Awake we fill the button image with the icon.
		_iconImage = GetComponentInChildren<Image>();
		_iconImage.sprite = IconImage;

		// Here we use GetComponent to get the Slider Component in the Child
		// of this GameObject.
	...
	public void SkillOnClick()
	{
		if (!_locked)
		{
			...
			// Here you would call the function that implements
			// the button gameplay logic, buffs, debuffs, attack anims etc.
			
			// This function could be part of an inherited class
			// specific to the gameplay functioanlity you require.
		}
